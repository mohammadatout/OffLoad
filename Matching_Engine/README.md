...
|---------|------|-------------|
| v1 | `entity_matcher.py` | Full similarity matrix, UMC+EXC, TF-IDF |
| v3 | `entity_matcher_v3.py` | State blocking, abbreviation expansion, phonetic matching (95.7% match rate) |
| v4 | `entity_matcher_v4.py` | Multi-stage matching, context validation, word-order tolerance |
